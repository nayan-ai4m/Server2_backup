...
public:
	...
	streamer.publish("/mc20", std::string(streamImage.begin(), streamImage.end()));
    }
private:
...
int main() {
	...
	//black
        //camera.f().ExposureTime.Set(6519.00);
	...
	//cp
	camera.f().ExposureTime.Set(3000.00);  //sunsilk black_6519_00
	camera.f().Gain.Set(1.99);    //sunsilk black_3_98
