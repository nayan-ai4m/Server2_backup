...
TABLES = [
    ...
    'case_erector_tp_status',
    'case_erector_tp_status_loop4',
    'check_weigher_tp_status',
    'check_weigher_tp_status_loop4',
    'highbay_tp_status',
    'highbay_tp_status_loop4',
    'press_tp_status',
    'press_tp_status_loop4',
    'tpmc_tp_status',
    'tpmc_tp_status_loop4'
]

# Map tables to their corresponding machine names for tp_history
MACHINE_NAME_MAP = {
    **{f'mc{i}_tp_status': f'mc{i}' for i in range(17, 23)},
    **{f'mc{i}_tp_status': f'mc{i}' for i in range(25, 31)},
    'case_erector_tp_status': 'mcce3',
    'case_erector_tp_status_loop4': 'mcce4',
    'check_weigher_tp_status': 'mcckwr3',
    'check_weigher_tp_status_loop4': 'mcckwr4',
    'highbay_tp_status': 'mchighbay3',
    'highbay_tp_status_loop4': 'mchighbay4',
    'press_tp_status': 'mcpress3',
    'press_tp_status_loop4': 'mcpress4',
    'tpmc_tp_status': 'mctp3',
    'tpmc_tp_status_loop4': 'mctp4'
}
...
def main():
    ...
    try:
        while True:
            for table in TABLES:
                machine = MACHINE_NAME_MAP.get(table, table.split('_')[0].upper())
