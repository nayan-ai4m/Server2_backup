...
class StatusMonitor:
    def __init__(self, db_config):
        ...
        try:
            excel_path = '/home/ai4m/develop/DQ/plc_tags/Write_events/loop3_status_msg.xlsx'
    ...
    def insert_event(self, machine, status, status_code, timestamp):
        ...
        try:
            with self.connect_db() as conn:
                with conn.cursor() as cursor:
                    ...
                    """, (
                        ...
                        event_id,
                        f"Loop3_{machine}",
                        self.get_fault_message(status_code),
                        "productivity"
                    ))
            ...
            print(f"Issue: {self.get_fault_message(status_code)}")
