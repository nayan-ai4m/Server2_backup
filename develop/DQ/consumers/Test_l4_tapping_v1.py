...
CONFIG = {
    ...
    'zones': {
        ...
        'status_file': 'zone_status_l4_tapping_demo.json'
    }
}
...
class L4TapingMonitor:
    ...
    def _setup_logging(self):
        ...
        debug_handler = logging.FileHandler('debug_l4_taping.log')
...
"""
    ...
    def process_message(self, message: Dict[str, Any]):
        ...
        try:
            ...
            # Check if message is from l4_taping sensor
            if message["sensorId"] != "l4_taping":
    ...
    def run(self):
        """Main execution loop"""
        try:
            logging.info("Starting L4 Taping Monitor...")
...
if __name__ == "__main__":
    try:
        monitor = L4TapingMonitor(CONFIG)
        monitor.run()
    except Exception as e:
