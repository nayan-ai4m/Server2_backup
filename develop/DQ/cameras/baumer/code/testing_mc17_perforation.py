    ...
    def process(self, img):
        ...
        while threading.active_count() > 1 or not self.q.empty():
            if not self.q.empty():
                ...
                cv2.imwrite("/home/ai4m/develop/backup/develop/DQ/cameras/baumer/may29_infer/"+str(datetime.datetime.now().strftime("%m_%d_%Y_%H_%M_%S_%p"))+".jpeg",image)
...
if __name__ == '__main__':
    config = {
        'input_dir': '/home/ai4m/develop/backup/develop/DQ/cameras/baumer/data_may27/mc17_redtape2/',
        'output_dir': '/home/ai4m/develop/data/sample_baumer',
        'models': {
