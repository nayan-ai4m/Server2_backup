...
def read_plc_tag(tag_queue, plc_ip):
    ...
    tag_name = ["MX02_HT_Transfer_TS", "HTloop3_Level", "HTloop3_Primary_Tank", "HTloop3_Secondary_Tank", "MX02_Batch_No_D", "MX02_Batch_Mfg_Date", "MX02_Batch_SKU", "MX02_Shift_D"]
    while True:
        try:
