...
MODBUS_SERVER_IP = '141.141.143.86'  # Replace with your device's IP address
        ...
        while True:
            ...
            try:
                ...
                if previous_value == 0 and current_value != 0:
                    ...
                    insert_query = """
                        INSERT INTO loop4_checkweigher("timestamp", cld_weight, cld_total, cld_over, cld_under, cld_proper, target_weight, upper_limit, lower_limit) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s);"""
                    try:
