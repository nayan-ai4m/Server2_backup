        ...
        for machine_name in machine_names:
            if machine_name in zone_nodes:
               ...
               # Getting the Current Status of the Node/Zone from Memgraph to check with the New Status
                ...
                if "temp" in current_status or 'no_cld' in current_status or 'possible_' in current_status :
                ...
                downgrade_jamming = current_status == "jamming" and "temp" in new_status
                #downgrade_jamming = (
