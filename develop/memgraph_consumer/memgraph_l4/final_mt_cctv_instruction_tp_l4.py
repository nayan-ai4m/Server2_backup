...
def update_status(machine, status, orient):
    try:
        part = machine.lower()
        if part not in ['l4_tapping_outfeed', 'pre_taping_l4','l4_tapping_postoutfeed', "l4_outfeed", "check_weigher_rejection_l4", "case_erector_conveyor_l4","highbay_l4","cw_outfeed_l4"]:
