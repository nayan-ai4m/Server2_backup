...
def update_status(machine, status, orient):
    try:
        part = machine.lower()
        if part not in ['l3_tapping_outfeed','pre_taping_l3','l3_tapping_postoutfeed', "l3_outfeed", "check_weigher_rejection_l3", "case_erector_conveyor_l3","highbay_l3","cw_outfeed_l3"]:
