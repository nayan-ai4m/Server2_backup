...
if __name__ == '__main__':
    config = {
        ...
        'zone': (104,526,2018,580), #(732,568,1656,660) ,#(986,620, 1298,664)
        'eyemark_threshold': 5
    }
    ...
    try:
        while True:
            ...
            if socket_mc17 in socks and socks[socket_mc17] == zmq.POLLIN:
               ...
               # cv2.imwrite("/home/ai4m/develop/baumer/data/mc17/mc17"+str(datetime.datetime.now().strftime("%m_%d_%Y_%H_%M_%S_%f_%p"))+".png",frame)
