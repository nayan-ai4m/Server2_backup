"""
Loop3 Perforation Monitoring (MC17–MC22)

Real-time monitoring of Perforation across MC17–MC22:
...
db_cfg = config["db"]
BASE_URL = db_cfg.get("base_url", "http://192.168.0.185:8015")  # ✅ Correct base URL
