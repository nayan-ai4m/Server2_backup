...
config = {
    ...
    'zone': np.array([
        #(6,9),(2034,9),(2034,279),(6,279)
	(30,307),(2017,361),(2013,551),(24,478)
        #(21, 228),(1506, 233),(1517, 376),(19, 387)
...
def insert_status(avg_count, tp_db_config, event_db_config, frame=None):
    ...
    if active == 1 and frame is not None:
        ...
        filename = f"low_perforation_mc25_{timestamp_str}.jpeg"
    ...
    try:
        ...
        cur_tp.execute("UPDATE mc25_tp_status SET tp18 = %s", (json.dumps(tp_data),))
        if cur_tp.rowcount == 0:
            cur_tp.execute("INSERT INTO mc25_tp_status (tp18) VALUES (%s)", (json.dumps(tp_data),))
        conn_tp.commit()
        cur_tp.close()
        conn_tp.close()
